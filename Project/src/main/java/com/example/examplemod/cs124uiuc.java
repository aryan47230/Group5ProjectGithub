...
public class cs124uiuc {
	...
	public static final Supplier<ConsumeEffect.Type<UsePortalConsumeEffect>> USE_PORTAL = CONSUME_EFFECT_TYPES.register(
			"use_portal", () -> new ConsumeEffect.Type(UsePortalConsumeEffect.CODEC, UsePortalConsumeEffect.STREAM_CODEC));
	public static final Supplier<ConsumeEffect.Type<UseUIUCConsumeEffect>> USE_UIUC = CONSUME_EFFECT_TYPES.register(
			"use_uiuc", () -> new ConsumeEffect.Type(UseUIUCConsumeEffect.CODEC, UseUIUCConsumeEffect.STREAM_CODEC));
